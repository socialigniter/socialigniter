...
{ 
    function __construct() 
    {
		...
		if($this->user)
		{
			...
			{
				if ($follow_check = $this->social_tools->check_relationship_exists(array('site_id' => config_item('site_id'), 'owner_id' => $this->session->userdata('user_id'), 'user_id' => $this->user->user_id, 'module' => 'site', 'type' => 'follow', 'status' => 'Y')))
				{
