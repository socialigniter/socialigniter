...
class Users extends Oauth_Controller
{
    ...
    /**
     * set_userdata_signup_email_post function.
     * 
     * @access public
     * @return void
     */
	    	...
	    	$this->form_validation->set_rules('email', 'Email Address', 'required|valid_email');	
       		...
       		if ($this->form_validation->run() == true):
		    	...
		    	if ($this->social_auth->update_user($user->user_id, $update_data)):
		    		if ($this->input->post('session') == 1):
		    			$updated_user = $this->social_auth->get_user('user_id', $this->oauth_user_id, TRUE);

		    			$this->social_auth->set_userdata($updated_user);
					endif;
    ...
    /**
     * upload_profile_picture_post function.
     * 
     * @access public
     * @return void
     */
    ...
    /**
     * delete_profile_picture_authd_get function.
     * 
     * @access public
     * @return void
     */
    ...
    /**
     * mobile_add_authd_post function.
     * 
     * @access public
     * @return void
     */
    ...
    /**
     * mobile_modify_authd_post function.
     * 
     * @access public
     * @return void
     */
    ...
    /**
     * mobile_destroy_authd_get function.
     * 
     * @access public
     * @return void
     */
    ...
    /**
     * device_create_authd_post function.
     * 
     * @access public
     * @return void
     */
