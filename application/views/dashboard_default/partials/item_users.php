<li class="item_manage" id="item_<?= $user_id; ?>" rel="users">
	...
	<span class="item_manage_name"><a class="name" href="<?= $profile ?>"><?= $name ?></a></span>		
	<span class="item_alerts" id="item_alerts_<?= $user_id ?>"><?= $user_alerts ?></span>

	<span class="item_email hide"><?= $email ?></span>
	<span class="item_user_level_id hide"><?= $user_level_id ?></span>
	<span class="item_active hide"><?= $active ?></span>
