...
$(document).ready(function()
{
	...
	$('.widget_add').bind('click', function(e)
    {
		...
		{
			// Get Add Dialog
			var partial_html = '<form name="widget_setting" method="post" id="widget_setting" enctype="multipart/form-data"><ul id="widgets_available"></ul></form>';
			...
			$('<div />').html(partial_html).dialog(
			{
				...
				create	: function()
				{
					...
					$('.widget_add_instance').bind('click', function(add_eve)
					{
						...
						widget_json.layout	= $('#this_layout').val();							
