...
#widget_content_area 				{ width: 545px; padding:0 0 0 12px; margin: 25px 0 10px 0; float: left; }
#widget_sidebar_area 				{ width: 275px; padding:0 0 0 12px; margin: 25px 0 10px 35px; float: left; }
