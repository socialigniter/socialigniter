...
<div class="content_norm_mid">
	    ...
	    <tr>
			<td>Username:</td>
			<td><input type="text" name="username" value="<?= set_value('username', $username) ?>"></td>
		</tr>
	    <tr>
			<td>Email:</td>
			<td><input type="email" name="email" value="<?= set_value('email', $email) ?>"></td>
		</tr>
		<tr>
			<td>Home Base:</td>
		...
		<tr>
			...
			<td><?= form_dropdown('language', $this->config->item('languages'), $language); ?></td>		
		</tr>
		<tr>
