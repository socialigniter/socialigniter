 ...
 * ## Purpose
 * 
 * This script is designed to enable CodeIgniter controllers and functions to be easily called from the command 
 * line on UNIX/Linux systems.
 *
 *
 * ## Setup
 * 
 ...
 *    <kbd>./cron.php --run=/controller/method [--show-output] [--log-file=logfile] [--time-limit=N] [--server=http_server_name]</kbd>
 *
 *
 * ## Options
 * 
 ...
 *
 *
 * NOTE: Do not load any authentication or session libraries in controllers you want to run via cron.
 * If you do, they probably won't run right.
 * 
 * CodeIgniter forum member "compwright" (http://codeigniter.com/forums/member/60942/)
 * 
 *  ## Contributions:
 * 
 *    "BDT" (http://codeigniter.com/forums/member/46597/) -- Fix for undefined constant CRON_FLUSH_BUFFERS error 
 * 	  if the --show-output switch is not set (11/17/2008)
 ...
 * @package Jonathon Hill\Cron
 */

define('CRON_CI_INDEX', '/Applications/MAMP/htdocs/index.php');   // Your CodeIgniter main index.php file
