...
CREATE TABLE  `content_meta` (
  ...
  `meta` VARCHAR( 128 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL ,
...
INSERT INTO `settings` VALUES(NULL, 1, 'users', 'images_large_width', '175');
...
INSERT INTO `settings` VALUES(NULL, 1, 'users', 'images_small_width', '25');
