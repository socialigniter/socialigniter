...
CREATE TABLE `content` (
  ...
  `canonical` varchar(512) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `settings` VALUES(NULL, 1, 'services', 'akismet_key', '');
INSERT INTO `settings` VALUES(NULL, 1, 'services', 'recaptcha_public', '');
INSERT INTO `settings` VALUES(NULL, 1, 'services', 'recaptcha_private', '');
...
INSERT INTO `settings` VALUES(NULL, 1, 'users', 'images_max_size', '5120');
