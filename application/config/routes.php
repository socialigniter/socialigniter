...
/* Settings */
$route['api/settings/view/(:any)/(:any)']			= 'api/settings/view/$1/$2';
...
/* Custom Routes */
$route['portland/(:any)/(:any)/(:any)']				= 'classes/product';
$route['bay-area/(:any)/(:any)/(:any)']				= 'classes/product';
$route['earth/(:any)/(:any)/(:any)']				= 'classes/product';
$route['portland/(:any)/(:any)']					= 'classes/category';
$route['bay-area/(:any)/(:any)']					= 'classes/category';
$route['earth/(:any)/(:any)']						= 'classes/category';
$route['portland/(:any)']							= 'classes/category';
$route['bay-area/(:any)']							= 'classes/category';
$route['earth/(:any)']								= 'classes/category';
$route['portland']									= 'classes/mashup';
$route['bay-area']									= 'classes/mashup';
$route['earth']										= 'classes/mashup';
